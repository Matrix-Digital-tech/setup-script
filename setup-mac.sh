...
run_section "SSH key + 1Password agent"             "$SCRIPT_DIR/scripts/ssh.sh"           "ssh"
...
echo "  3. Enable 1Password SSH: 1Password → Settings → Developer → SSH Agent"
echo "  4. Authenticate gws:     gws auth"
echo "  5. Add Perplexity key:   op item create --category=apikey --title=Perplexity --vault=Development api_key=pplx-..."
echo "  6. OpenWhispr:           https://openwhispr.com/download"
echo ""
